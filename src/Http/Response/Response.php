...
use MonoKit\Http\HeaderManager;
use MonoKit\Http\Response\Interfaces\ResponseInterface;

Class Response extends Entity implements ResponseInterface
{
    ...
    public function __construct( $content = null , $status = self::HTTP_OK )
    {
        ...
        $this->setHeaderManager( new HeaderManager() );
    }
    ...
    {
        $this->getHeaderManager()->addHeader( $header );
        return $this;
    }
    ...
    public function getHeaders()
    {
        ...
        header("{$protocol} {$this->getStatus()} {$text}");

        foreach( $this->getHeaderManager() AS $Header )
